...
| `view.load_event`               | number (ns) | Time until the load event is fired, indicating when the page is fully loaded. Usually a trigger for additional application logic. [More info from the MDN documentation][16]                                                                             |
